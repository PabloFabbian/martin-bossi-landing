        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative group">
                <p
                  className="underline cursor-pointer hover:text-yellow-400 md:text-white transition-colors"
                  onClick={() => {
            ...
            <div className="flex space-x-4 pt-2 pl-0.5">
              <a href="#" className="transition-transform duration-300 hover:scale-125 hover:-translate-y-1" aria-label="Facebook">
              ...
              <a href="#" className="transition-transform duration-300 hover:scale-125 hover:-translate-y-1" aria-label="Twitter">
              ...
              <a href="#" className="transition-transform duration-300 hover:scale-125 hover:-translate-y-1" aria-label="Instagram">
              ...
              <a href="#" className="transition-transform duration-300 hover:scale-125 hover:-translate-y-1" aria-label="LinkedIn">
          ...
          <div className="md:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
              <div className="space-y-2 pl-10 lg:pl-36 text-start hidden md:block">
                <a href="#nosotros" onClick={(e) => scrollToSection('#nosotros', e)} className="hover:text-yellow-400 block cursor-pointer">Nosotros</a>
                <a href="#servicios" onClick={(e) => scrollToSection('#servicios', e)} className="hover:text-yellow-400 block cursor-pointer">Servicios</a>
                <a href="#cotizacion" onClick={(e) => scrollToSection('#cotizacion', e)} className="hover:text-yellow-400 block cursor-pointer">Cotizá tu operación</a>
                <a href="#contacto" onClick={(e) => scrollToSection('#contacto', e)} className="hover:text-yellow-400 block cursor-pointer">Contacto</a>
                <a href="#faq" onClick={(e) => scrollToSection('#faq', e)} className="hover:text-yellow-400 block cursor-pointer">FAQ's</a>
              </div>
