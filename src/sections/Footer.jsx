        ...
        <div className="md:col-span-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
            <div className="space-y-2 pl-20 md:pl-36 text-start">
              <a href="#nosotros" className="transition-transform duration-300 hover:scale-[1.025] hover:text-yellow-400 block">Nosotros</a>
              <a href="#servicios" className="transition-transform duration-300 hover:scale-[1.025] hover:text-yellow-400 block">Servicios</a>
              <a href="#cotizacion" className="transition-transform duration-300 hover:scale-[1.025] hover:text-yellow-400 block">Cotizá tu operación</a>
              <a href="#contacto" className="transition-transform duration-300 hover:scale-[1.025] hover:text-yellow-400 block">Contacto</a>
              <a href="#faqs" className="transition-transform duration-300 hover:scale-[1.025] hover:text-yellow-400 block">FAQ's</a>
            </div>
