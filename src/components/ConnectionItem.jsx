...
const ConnectionItem = ({ icon, title, description }) => {
  return (
    <div className="flex flex-col gap-2 p-4 rounded-lg bg-gradient-to-br from-[#0D1224] to-[#0D1224]/50 hover:scale-105 transition-transform duration-300 hover:pointer-default">
